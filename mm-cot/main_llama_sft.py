...
from utils_data import img_shape, load_data_std, load_data_img, ScienceQADatasetStd, ScienceQADatasetImg, ScienceQADatasetImgSFT, ScienceQADatasetImgSFTHF
...
def LlamaTrainer(
    ...
    if args.img_type is not None:
        ...
        if args.use_quant:
            bnb_config = BitsAndBytesConfig(
                    ...
                    bnb_4bit_quant_type="nf4",             # try "nf4"; other options: "fp4", "fp4-s"
            ...
            model = LlamaForMultimodalGeneration.from_pretrained(args.model,
        ...
        train_set = ScienceQADatasetImgSFTHF(
            problems,
            train_qids,
            name_maps,
            tokenizer,
        ...
        eval_set = ScienceQADatasetImgSFTHF(
            problems,
            val_qids,
            name_maps,
            tokenizer,
        ...
        test_set = ScienceQADatasetImgSFTHF(
            problems,
            test_qids,
            name_maps,
            tokenizer,
        ...
        model = LlamaForCausalLM.from_pretrained(args.model, token=hf_token) 
    ...
    if getattr(args, "use_lora", False):
        ...
        for layer in [model.mha_layer, model.image_dense, model.gate_dense]:
    ...
    trainer = SFTTrainer(
        ...
        tokenizer=tokenizer,
        max_seq_length=args.output_len,
    ...
    predict_results = trainer.predict(test_dataset=test_set) 
    ...
    if args.prompt_format == "QCM-LE" or args.prompt_format == "QCM-E":
        ...
        predict_results = trainer.predict(test_dataset=eval_set) 
        if trainer.is_world_process_zero():
