...
from utils_data import img_shape, load_data_std, load_data_img, ScienceQADatasetImgInference, ScienceQADatasetStdInference, ScienceQADatasetStd, ScienceQADatasetImg, ScienceQADatasetImgSFT, ScienceQADatasetImgSFTHF
...
def T5Inferencer(
    ...
    test_set = ScienceQADatasetImgInference(
        problems,
        test_qids,
        name_maps,
        tokenizer,
